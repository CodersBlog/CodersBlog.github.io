---
title: "[Server] Zabbix로 여러 서버 리소스 모니터링하기"
excerpt: "zabbix-server-setting by sehoon-lee"
description: "여러 서버의 리소스를 한 화면에서 모니터링하기 위해 Zabbix 서버를 설치하고 agent2를 설정하는 과정을 정리합니다."
...
## **주의**
**현재 각 서버 세팅상황에 따라 설치 상황이 다를 수 있다. 기본적으로는 apach를 설치하며, 버전도 다를 수가 있다.**
...
### Zabbix 화면 예시
![img_file](/assets/img/post/zabbix/zabbix_example.png)