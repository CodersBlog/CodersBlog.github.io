---
title: "[Time Series] SegRNN: Segment Recurrent Neural Network for Long-Term Time Series Forecasting"
excerpt: "Paper review by Junhyuns"
description: "장기 시계열 예측 모델 SegRNN 논문 리뷰. 세그먼트 단위로 나눠 처리하는 RNN 구조와 positional encoding 설계를 정리합니다."
